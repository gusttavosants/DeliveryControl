...
const Reports = () => {
  ...
  // Performance data for motoboys
  const motoboyPerformance = [
    { nome: 'João Silva', entregas: 145, taxas: 950, taxaTotal: 950, tempoMedio: 18, tendencia: 15, avaliacao: 4.8, cancelamentos: 3 },
    { nome: 'Carlos Santos', entregas: 120, taxas: 780, taxaTotal: 780, tempoMedio: 20, tendencia: 8, avaliacao: 4.5, cancelamentos: 5 },
    { nome: 'Pedro Lima', entregas: 98, taxas: 640, taxaTotal: 640, tempoMedio: 22, tendencia: -3, avaliacao: 4.2, cancelamentos: 8 },
    { nome: 'Lucas Souza', entregas: 75, taxas: 490, taxaTotal: 490, tempoMedio: 25, tendencia: 12, avaliacao: 4.6, cancelamentos: 2 },
  ];
